...
dag_file_path = '/user/rstanley/simulations/HTCondor/surface/dagfiles/{0}/{1}/'.format(get_date, get_time)
os.makedirs(dag_file_path, exist_ok=True)
dag_file = '/user/rstanley/simulations/HTCondor/surface/dagfiles/{0}/{1}/run_surface_sim_{0}_{1}.dag'.format(get_date, get_time)
